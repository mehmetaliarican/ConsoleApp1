...
namespace KPSClientNS
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="KPSClientNS.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        KPSClientNS.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(KPSClientNS.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<KPSClientNS.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(KPSClientNS.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public KPSClientNS.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(KPSClientNS.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public KPSClientNS.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(KPSClientNS.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface KPSPublicSoapChannel : KPSClientNS.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<KPSClientNS.KPSPublicSoap>, KPSClientNS.KPSPublicSoap
    {
        ...
        public KPSClientNS.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(KPSClientNS.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrula(request);
        }
        
        public System.Threading.Tasks.Task<KPSClientNS.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(KPSClientNS.TCKimlikNoDogrulaRequest request)
        {
